    ...
    if (quizzes.length === 0) {
      return (
        <EmptyState
          ...
          description="Generate a quiz from your documnet to test your knowledge"
        />
      );
    }
        ...
        <form onSubmit={handleGenerateQuiz} className="space-y-4">
          <div>
            ...
            <input
              ...
              min="1"
              required
              className="w-full h-9 px-3 border border-neutral-200 riunded-lg bg-white text-sm text-neutral-900 placeholder-neutral-400 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-[#00d492] focus:border-transparent"
            />
          </div>
