...
import { BrainCircuit, Mail, ArrowRight, Lock, User } from "lucide-react";
        ...
        <div className="bg-white/80 backdrop-blur-xl border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-slate-500 text-sm">
              Start your AT-powered learning experience
            </p>
          </div>
          ...
          <div className="space-y-5">
            ...
            {/* Error message */}
            {error && (
              <div className="rounde-lg bg-red-50 border border-red-200">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-whit/20 to-white/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700" />
            </button>
          </div>
