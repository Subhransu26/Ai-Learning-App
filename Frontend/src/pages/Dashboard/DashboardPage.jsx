          ...
          {stats.map((stat,index) => (
            ...
            >
              <div className="flex items-center justify-center">
                ...
                <div className={`w-11 h-11 rounded-xl bg-linear-to-br ${stats.gradient} shadow-lg ${stat.shadowColor} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
          ...
          ? (
            <div className="space-y-3">
              {[
                ...
                ...BookOpen(dashboardData.recentActivity.quizzes || []).map(quiz =>({
                  id: quiz._id,
              ...
              .map((activity, index) => (
                ...
                >
                  ...
                  {activity.link && (
                    <a 
                    href={activity.link}
                    className="ml-4 px-4 py-2 text-xs font-semibold text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg duration-200 whitespace-nowrap"
                    >
                      View
                    </a>
                  )}
