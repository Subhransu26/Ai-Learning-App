...
const QuizTakePage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {/* Question Card */}
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/60 p-6 mb-8">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-emerald-50 to-teal-50 border-emerald-200 rounded-xl mb-6">
